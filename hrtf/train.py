...
if __name__ == "__main__":
    ...
    frequency = torch.rand(0, 41, 128)
    # left_or_right = torch.LongTensor(np.random.randint(0, 2, 128))
    left_or_right = torch.rand(0, 2, 128)

    # print(summary(ConvNNHrtfSht(args), ear_anthro, head_anthro, frequency, left_or_right, show_input=False))
    # print(summary(ConvNNHrtfSht(args), (ear_anthro, head_anthro, frequency, left_or_right)), dtypes=[torch.long])
